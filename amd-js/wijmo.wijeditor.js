 ...
 */
var wijmo;
define(["wijmo.widget", "wijmo.wijsplitter", "wijmo.wijdialog", "globalize", "wijmo.wijribbon"], function () { 
    ...
    (function (editor) {
        ...
        var wijeditor = (function (_super) {
            ...
            */
                ...
                switch(cmd) {
                    case cmd_blockquote:
                        if($.browser.msie) {
                            ...
                            if($.browser.version && parseFloat($.browser.version) >= 11 && doc.getSelection) {
            ...
            wijeditor.prototype._getHtmlTextInIE = //end of color dialog.
            function (doc) {
                if(!$.browser.msie || !doc) {
                    return "";
                }
            ...
            wijeditor.prototype.initInsertTableDialog = //begin to handle the table dialog.
