 ...
 */
var wijmo;
define(["wijmo.widget", "wijmo.wijutil"], function () { 
        ...
        var wijappview = (function (_super) {
            ...
            */
            function (toPage, options) {
                ...
                toPage.jqmData("mobile-page", this._jqmPageEnclosingWidget).jqmData("page", this._jqmPageEnclosingWidget).trigger("pagecreate").trigger(this.widgetEventPrefix + "pageinit", triggerData);
