 ...
 */
var wijmo;
define(["wijmo.wijchartcore"], function () { 
        ...
        var PieChartRender = (function () {
            ...
            PieChartRender.prototype.render = function (radiusNotSet) {
                ...
                if(radiusNotSet && showChartLabels && (labelsOpts.position === "outside")) {
                    $.each(seriesList, function (idx, series) {
                        var actualSize, textStyle, chartLabel, formatter, label, labelBounds, tempRadius = radius, seriesWidth = 0, seriesHeight = 0, anglePlus = TwoPI * series.data / total, seriesAngle = anglePlus / 2 + calAngle;
                        series = $.extend(true, {
                            offset: 0
                        }, series);
                ...
                $.each(seriesList, function (idx, series) {
                    var seriesStyle = $.extend({
                        ...
                        stroke: "gray",
                        "stroke-width": 1
                    }, seriesStyles[idx % stylesLength]), anglePlus = TwoPI * series.data / total, cx = startX + radius, cy = startY + radius, center, sector, label, pos, textStyle, borderPos, tracker, chartLabel, formatter, labelPosition = labelsOpts.position, labelConnectorStyle = labelsOpts.connectorStyle, labelOffset = labelsOpts.offset, calculatedAngle, labelBounds, labelConnector, animate = false;
                    pieID = series.pieID;
            ...
            PieChartRender.prototype.bindLiveEvents = function () {
                var o = this.options, touchEnabled = o.widget._isTouchEnabled(), enableTouchBehavior = o.isTouchBehaviorEnable, ele = this.element, tooltip = o.tooltip, offset = {
                    x: 0,
                    y: 0
                }, touchEventPre = "", touchBehaviorEventPre = "", isFunction = $.isFunction, disabled = o.disabled, animation = o.animation;
                if(touchEnabled) {
                    touchEventPre = "wij";
                }
